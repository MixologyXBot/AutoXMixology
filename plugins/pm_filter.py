...
async def pm_text(bot, message):
    ...
    await message.reply_text(
         text=f"Hello <b>{user}</b> ,\n\nYou can't Get Movies/Series/Animes from here. Request it in our <b><a href=https://t.me/MixologyMoviesSeries>Mixology Movie, Series Group</a></b> Or Click on Button Below ⬇️", disable_web_page_preview=True,

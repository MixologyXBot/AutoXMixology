...
async def pm_text(bot, message):
    ...
    await message.reply_text(
         text=f"<b>Hey {user} ,\n\nYou Can't Get Movies/Series/Animes From Here. Request It In Our <a href=https://t.me/MixologyMoviesSeries>Mixology Movie, Series Group</a> Or Click Request Here Button Below ⬇️</b>", disable_web_page_preview=True,
